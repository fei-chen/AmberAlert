...
CASSANDRA_HEAPDUMP_DIR=/mnt/heap_dumps
...
JVM_OPTS="$JVM_OPTS -javaagent:/mnt/cassandra_latest/lib/jmxetric-1.0.4.jar=host=gmond1.bloomstore.us-east-1.bloomreach.com,port=8679,wireformat31x=true,config=/mnt/cassandra_latest/conf/jmxetric.xml"
